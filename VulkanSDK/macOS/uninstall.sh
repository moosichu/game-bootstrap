        ...
        date >> /tmp/VULKAN_UNINSTALL.log
            ...
            echo "Removing /usr/local/lib/libVkLayer_device_simulation.dylib" | tee -a /tmp/VULKAN_UNINSTALL.log
            rm -rf /usr/local/lib/libVkLayer_device_simulation.dylib
            ...
            echo "Removing /usr/local/lib/libvulkan.1.2.170.dylib" | tee -a /tmp/VULKAN_UNINSTALL.log
            rm -rf /usr/local/lib/libvulkan.1.2.170.dylib
            ...
            echo "Removing /usr/local/lib/libspirv-cross-c-shared.0.45.0.dylib" | tee -a /tmp/VULKAN_UNINSTALL.log
            rm -rf /usr/local/lib/libspirv-cross-c-shared.0.45.0.dylib
